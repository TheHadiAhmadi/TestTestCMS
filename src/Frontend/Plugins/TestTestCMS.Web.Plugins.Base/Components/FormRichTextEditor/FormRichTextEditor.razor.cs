...
namespace TestTestCMS.Web.Plugins;
...
public partial class FormRichTextEditor : IAsyncDisposable
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        Module = await JS.InvokeAsync<IJSObjectReference>("import", "/_content/TestTestCMS.Web.Plugins.Base/Components/FormRichTextEditor/FormRichTextEditor.razor.js");
