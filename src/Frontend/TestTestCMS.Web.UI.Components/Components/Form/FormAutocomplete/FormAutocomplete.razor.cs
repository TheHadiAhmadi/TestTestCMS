...
public partial class FormAutocomplete<TItem, TValue> : IAsyncDisposable
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        Module = await JS.InvokeAsync<IJSObjectReference>("import", "/_content/TestTestCMS.Web.UI.Components/Components/Form/FormAutocomplete/FormAutocomplete.razor.js");
