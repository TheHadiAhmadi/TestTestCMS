...
public partial class FormMarkdownEditor : IAsyncDisposable
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        Module = await JS.InvokeAsync<IJSObjectReference>("import", "/_content/TestTestCMS.Web.UI.Components/Components/Form/FormMarkdownEditor/FormMarkdownEditor.razor.js");
