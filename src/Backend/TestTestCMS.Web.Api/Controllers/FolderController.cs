using TestTestCMS.Web.Api.Models.Folder;
...
public class FolderController(IFolderService folderService, IFileService fileService, IMapper mapper) : BaseGlobalController
{
    ...
    [HttpPut]
    [Policy(AREA, UPDATE)]
    public async Task<IApiResult<FolderDetailResponse>> Move([FromBody] FolderMoveRequest request, CancellationToken cancellationToken = default)
    {
