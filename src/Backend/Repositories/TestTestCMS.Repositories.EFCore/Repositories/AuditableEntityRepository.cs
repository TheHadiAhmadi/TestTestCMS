...
public class AuditableEntityRepository<TEntity, TDBEntity>(TestTestCMSDbContext dbContext, IMapper mapper, IApiExecutionContext apiExecutionContext) : EntityRepository<TEntity, TDBEntity>(dbContext, mapper), IAuditableEntityRepository<TEntity, TDBEntity> where TEntity : class, IAuditableEntity where TDBEntity : class, IAuditableEntityModel
{
