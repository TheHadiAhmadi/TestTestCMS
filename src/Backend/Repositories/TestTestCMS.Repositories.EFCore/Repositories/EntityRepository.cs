...
public class EntityRepository<TEntity, TDBEntity>(TestTestCMSDbContext dbContext, IMapper mapper) : IEntityRepository<TEntity, TDBEntity> where TEntity : class, IEntity where TDBEntity : class, IEntityModel
{
    protected readonly TestTestCMSDbContext DbContext = dbContext;
