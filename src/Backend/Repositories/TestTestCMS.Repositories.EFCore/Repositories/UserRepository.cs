...
public class UserRepository(TestTestCMSDbContext dbContext, IMapper mapper, IApiExecutionContext apiExecutionContext) : AuditableEntityRepository<User, UserModel>(dbContext, mapper, apiExecutionContext), IUserRepository
{
