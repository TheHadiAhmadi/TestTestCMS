...
public class SiteRepository(TestTestCMSDbContext dbContext, IMapper mapper, IApiExecutionContext apiExecutionContext) : AuditableEntityRepository<Site, SiteModel>(dbContext, mapper, apiExecutionContext), ISiteRepository
{
