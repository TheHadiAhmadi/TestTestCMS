...
public class ContentTypeRepository(TestTestCMSDbContext dbContext, IMapper mapper, IApiExecutionContext apiExecutionContext) : SiteAssociatedRepository<ContentType, ContentTypeModel>(dbContext, mapper, apiExecutionContext), IContentTypeRepository
{
