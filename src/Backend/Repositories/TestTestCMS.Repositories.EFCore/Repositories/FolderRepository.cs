...
public class FolderRepository(TestTestCMSDbContext dbContext, IMapper mapper, IApiExecutionContext apiExecutionContext) : SiteAssociatedRepository<Folder, FolderModel>(dbContext, mapper, apiExecutionContext), IFolderRepository
{
