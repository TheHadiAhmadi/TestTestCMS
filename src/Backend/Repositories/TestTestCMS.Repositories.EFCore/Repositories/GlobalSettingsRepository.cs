...
public class GlobalSettingsRepository(TestTestCMSDbContext dbContext, IApiExecutionContext apiExecutionContext, IMapper mapper) : IGlobalSettingsRepository
{
