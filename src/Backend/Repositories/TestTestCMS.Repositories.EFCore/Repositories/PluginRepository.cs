...
public class PluginRepository(TestTestCMSDbContext dbContext,IMapper mapper, IApiExecutionContext apiExecutionContext) : SiteAssociatedRepository<Plugin, PluginModel>(dbContext, mapper, apiExecutionContext), IPluginRepository
{
