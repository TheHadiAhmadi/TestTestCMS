...
public class ApiTokenRepository(TestTestCMSDbContext dbContext, IMapper mapper, IApiExecutionContext apiExecutionContext) : AuditableEntityRepository<ApiToken, ApiTokenModel>(dbContext, mapper, apiExecutionContext), IApiTokenRepository
{
