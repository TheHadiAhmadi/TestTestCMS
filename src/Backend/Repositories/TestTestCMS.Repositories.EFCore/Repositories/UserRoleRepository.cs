...
public class UserRoleRepository(TestTestCMSDbContext dbContext, IMapper mapper, IApiExecutionContext apiExecutionContext) : SiteAssociatedRepository<UserRole, UserRoleModel>(dbContext, mapper, apiExecutionContext), IUserRoleRepository
{
