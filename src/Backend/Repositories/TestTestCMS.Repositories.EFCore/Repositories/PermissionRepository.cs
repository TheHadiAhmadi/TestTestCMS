...
public class PermissionRepository(TestTestCMSDbContext dbContext, IMapper mapper, IApiExecutionContext apiExecutionContext) : SiteAssociatedRepository<Permission, PermissionModel>(dbContext, mapper, apiExecutionContext), IPermissionRepository
{
